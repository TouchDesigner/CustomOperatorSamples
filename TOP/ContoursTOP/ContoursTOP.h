...
{
public:
    ContoursTOP(const OP_NodeInfo *info, TOP_Context* contest);
    virtual ~ContoursTOP();
...
private:
	...
	void                secondInputTopToMat(const TD::OP_Inputs*);

	void 		    cvMatToOutput(TOP_Output*) const;
	...
	OP_SmartRef<OP_TOPDownloadResult> myDownResInput1;
	OP_SmartRef<OP_TOPDownloadResult> myDownResInput2;
	OP_SmartRef<OP_TOPDownloadResult> myPrevDownResInput1;
	OP_SmartRef<OP_TOPDownloadResult> myPrevDownResInput2;
};
